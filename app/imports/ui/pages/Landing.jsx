        ...
        <div className='landing-header'>
          <Grid container centered stackable columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted>Each time you make a contact with a contact you can write a note that summarizes the conversation. This note is saved along with a timestamp with he contact.</Header>
            </Grid.Column>
          </Grid>
        </div>
    );
