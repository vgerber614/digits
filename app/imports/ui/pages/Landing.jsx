          ...
          <Grid container centered stackable columns={3}>
            ...
            <Grid.Column textAlign="center">
              ...
              <Header as='h3' inverted>This address book enables any number of users to register and save their business
                contacts. You csn only see the contacts you have created.</Header>
            </Grid.Column>

            <Grid.Column textAlign="center">
              <Icon name="file alternate outline" size="huge" inverted/>
            ...
            <Grid.Column textAlign="center">
              <Icon name="calendar checked outline" size="huge" inverted/>
